...
//첫 번째에는 엔티티 타입 클래스를 넣어 주고, 
//두 번째는 기본키 타입을 넣어 줍니다.
//JpaRepositoy는 기본적인 CRUD 및 페이징 처리를 위한 메소드가 정의돼 있습니다.
public interface ItemRepository extends JpaRepository<Item, Long>{
	...
	//상품을 삼품명과 상품 상세 설명을 OR 조건을 이용하여 조회하는 쿼리 메소드]
	...
	//출력 결과를 OrderBy키워드를 이용한다면 오름차순 또는 내림차순으로 
	//조회할 수 있습니다
